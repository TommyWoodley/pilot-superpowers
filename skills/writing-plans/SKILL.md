...
- Use the `executing-plans` skill to work through the tasks in batches with review checkpoints
- The plan includes detailed steps, file paths, and verification commands"
